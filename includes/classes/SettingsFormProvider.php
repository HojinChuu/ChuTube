...
class SettingsFormProvider {
    ...
    public function createPasswordForm()
    {
        ...
        $newConfirmPasswordInput = $this->createPasswordInput("newConfirmPassword", "Confirm new password");
    ...
    private function createEmailInput($value) 
    {
        ...
        return "<div class='form-group'>
                    <input class='form-control' type='text' placeholder='Email' value='$value' name='email' required>
                </div>";
    }
